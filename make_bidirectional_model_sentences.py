...
for step_ind in range(10):
    ...
    while num_sents<60:
        ...
        for samp in range(10000):                     
            ...
            if np.log(model1_sent1_prob) > step_low and np.log(model1_sent1_prob) < step_high:
            ...
            word1_inds=list(set(model1_word1_inds))

            model1_word1_probs=[model1_word1_probs[wi] for wi,i in enumerate(word1_inds)]
